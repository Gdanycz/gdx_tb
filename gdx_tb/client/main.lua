...
function DisableViolentActions()
    ...
    DisableControlAction(0, 106, true) -- Disable in-game mouse controls -- LEFT MOUSE BUTTON
    DisableControlAction(0, 140, true) -- R
	DisableControlAction(0, 141, true) -- Q
	DisableControlAction(0, 142, true) -- LEFT MOUSE BUTTON
	DisableControlAction(0, 327, true) -- F5 thief menu
	--DisableControlAction(0, 245, true) -- T chat
	DisableControlAction(0, 288, true) -- F1 mobil
	DisableControlAction(0, 170, true) -- F3 animace
	DisableControlAction(0, 167, true) -- F6 action menu
	DisableControlAction(0, 169, true) -- F8 console
